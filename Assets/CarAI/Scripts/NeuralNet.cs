...
public class NeuralNet : MonoBehaviour
{
    ...
    public NeuralNet(int _inputNeuronCount, int _outputNeuronCount, int _hiddenLayerCount, int _hiddenNeuronCount)
    {
    ...
    public NeuralNet InitiliseCopy(int _hiddenLayerCount, int _hiddenNeuronCount)
    {
    ...
    public (float, float) RunNetwork(float _inputA, float _inputB, float _inputC)
    {
        ...
        return (outputLayer.Sigmoid(outputLayer.matrix[0, 0]), outputLayer.Tanh(outputLayer.matrix[0, 1]));
    }
