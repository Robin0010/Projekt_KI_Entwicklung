...
public class GeneticBird : MonoBehaviour
{
    NeuralNetBird savedGenome;
    ...
    public NeuralNetBird[] population;
    ...
    public NeuralNetBird SaveGenome()
    {
    ...
    public void LoadGenome(NeuralNetBird _net)
    {
        savedGenome = _net;
        isLoaded = true;
    }
    ...
    {
        population = new NeuralNetBird[initialPopulation];
    ...
    private void FillPopulationWithRandomValues(NeuralNetBird[] newPopulation, int startingIndex)
    {
        while (startingIndex < initialPopulation)
        {
            newPopulation[startingIndex] = new NeuralNetBird();
            newPopulation[startingIndex].Initilise(controller.LAYERS, controller.NEURONS);
            startingIndex++;
        }
    }

    public void Death(float fitness, NeuralNetBird _network)
    {
    ...
    private void RePopulate()
    {
        ...
        NeuralNetBird[] newPopulation = PickBestPopulation();
    ...
    private void Mutate(NeuralNetBird[] newPopulation)
    {
    ...
    private void Crossover(NeuralNetBird[] newPopulation)
    {
        for (int i = 0; i < numberToCrossover; i += 2)
        {
            ...
            NeuralNetBird Child1 = new NeuralNetBird();
            NeuralNetBird Child2 = new NeuralNetBird();
    ...
    private NeuralNetBird[] PickBestPopulation()
    {
        NeuralNetBird[] newPopulation = new NeuralNetBird[initialPopulation];
    ...
    private void SortPopulation()
    {
        for (int i = 0; i < population.Length; i++)
        {
            for (int j = i; j < population.Length; j++)
            {
                ...
                {
                    NeuralNetBird temp = population[i];
